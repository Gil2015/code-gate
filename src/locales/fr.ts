...
export const fr: Translation = {
  cli: {
    ...
    preparingReviewAgent: '[Mode Agent] Préparation de la révision pour {total} fichiers...',
    analyzing: 'Analyse en cours [{idx}/{total}] {file}',
    analyzingAgent: '[Agent] Collecte du contexte...',
    agentToolCall: '[Agent] Appel d\'outil: {tool}',
